 ...
 *just commented out, in case any one needs to modify the code. But this is a stable build.
 *Other files required are cudaarmwrappers.h, the header file, and gpusolve.cu where the function
 *solveviacuda() is actually defined.
 **/
#include <iostream>
#include <armadillo>
#include "cusparse.h"
